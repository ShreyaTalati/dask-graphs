            ...
            for t in [1000, 2000, 4000, 8000, 16000, 32000, 64000]:
                for workers in [1, 2, 4, 8, 15]:
                        try:
                            ...
                            file_name = f"output/_workers_{workers}__sleep_1__strong_0__steps_{n}__isync_0__restrict_0__t_{t}__deps_1__frac_{frac}__accesses_{acc}__width_{width}.txt"
                            f = open(file_name, "r")
                            lines = f.readlines()
